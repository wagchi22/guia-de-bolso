...
* **Backlight:** 80 %red%*\*Ou 100 em HDR*%% 
* **Contraste:** 80 %red%*\*Ou 100 em HDR*%%
* **Brilho:** 50
* **Nitidez:** 10
* **Cor:** 50
* **Gama de cores:** Automático %red%*\*Se não tiver, use Padrão*%%
* **Gama:** 2.2
* **Balanço de branco:**
	...
	* **Verde:** 40
	* **Azul:** -20
* **Nível de preto:** Automático %red%*\*Se não tiver, use Baixo*%%
* **Mapeamento de tom dinâmico:** Desativado para Cinema, HGiG para Jogos %red%*\*Referente ao tipo de contéudo exibido*%%
...
* **Extensões:** 
	- Bitwarden %red%*\*Desative as notificações*%%	
	- uBlock Origin Lite %red%*\*Ajuste para modo Completo com todos os filtros ativados*%%
	- Tampermonkey %red%*\*Adicione o script BLUDV Bypass e permita scripts de usuário*%%
